...
const BookDetailsRight = ({ title, publisher, category, description }) => {
    ...
    return (
        ...
        >
            ...
            <button type="button" class="btn btn-info" style={{width:'6rem',border: "2px solid #000d42"}}>Preview</button>

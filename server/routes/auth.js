...
router.get('/admin/bookinfo',setadminbook);
...
router.get('/admin/bookrank',getBookRankAdmin);
...
router.get('/admin/cearnings',cEarningsadmin);
router.get('/admin/learnings',lEarningsadmin);
...
router.get('/gettransferrequests',gettransferrequests);
router.get('/get_sellerinfo',getSellerInfo);
router.post('/api/transfer',handleTransfer);
router.post('/api/transferrejected',handleRejection);
